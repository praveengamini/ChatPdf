...
const SideBar = ({ searchDialogOpen, setSearchDialogOpen, onDocumentSelect, onNewChat }) => {
  ...
  return (
    <>
        ...
        <Sheet open={mobileSheetOpen} onOpenChange={setMobileSheetOpen}>
          <SheetTrigger asChild>
            <Button
              variant="outline"
              size="icon"
              className="backdrop-blur-md bg-black/70 border-white/20 text-white hover:bg-white/20 hover:text-white"
            >
          ...
          <SheetContent 
            side="left" 
            className="w-80 p-0 backdrop-blur-md bg-black/90 border-white/20"
          >
      ...
      <aside className="hidden lg:block fixed inset-y-0 left-0 z-10 w-64 backdrop-blur-md bg-black/70 text-white shadow-2xl border-r border-white/10">
        <SidebarContent />
      </aside>
